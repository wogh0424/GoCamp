		...
		<div id="modifycamp">
			...
			<div class="division" style="border-bottom: 1px dashed grey;"> <!-- bottom 구획  -->
				...
				<div style="flex:1;">  <!-- bottom 구획 구분 2 -->
					...
					<ul>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl01" value="일출명소" 	${fn:contains(item.themaEnvrnCl,'일출명소') ? 'checked' : '' }>
							<label for="themaEnvrnCl01">일출명소</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl" class="check05" id="themaEnvrnCl02" value="일몰명소" ${fn:contains(item.themaEnvrnCl,'일몰명소') ? 'checked' : '' }> 
							<label for="themaEnvrnCl02"	>일몰명소</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl03" value="수상레저" ${fn:contains(item.themaEnvrnCl,'수상레저') ? 'checked' : '' }> 
							<label	for="themaEnvrnCl03" >수상레저</label></li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl04" value="항공레저" ${fn:contains(item.themaEnvrnCl,'항공레저') ? 'checked' : '' }> 
							<label	for="themaEnvrnCl04" >항공레저</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl05" value="스키"	${fn:contains(item.themaEnvrnCl,'스키') ? 'checked' : '' }>
							<label for="themaEnvrnCl05">스키</label></li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl06" value="낚시"	${fn:contains(item.themaEnvrnCl,'낚시') ? 'checked' : '' }>
							<label for="themaEnvrnCl06">낚시</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl07" value="액티비티"	${fn:contains(item.themaEnvrnCl,'액티비티') ? 'checked' : '' }>
							<label for="themaEnvrnCl07">액티비티</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl08" value="봄꽃여행"	${fn:contains(item.themaEnvrnCl,'봄꽃여행') ? 'checked' : '' }>
							<label for="themaEnvrnCl08">봄꽃여행</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl09" value="여름물놀이"	${fn:contains(item.themaEnvrnCl,'여름물놀이') ? 'checked' : '' }>
							<label for="themaEnvrnCl09">여름물놀이</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl10" value="가을단풍명소"	${fn:contains(item.themaEnvrnCl,'가을단풍명소') ? 'checked' : '' }>
							<label for="themaEnvrnCl10">가을단풍명소</label>
							
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl11" value="겨울눈꽃명소"	${fn:contains(item.themaEnvrnCl,'겨울눈꽃명소') ? 'checked' : '' }>
							<label for="themaEnvrnCl11">겨울눈꽃명소</label>
						</li>
						<li>
							<input type="checkbox" name="themaEnvrnCl"	class="check05" id="themaEnvrnCl12" value="걷기길"	${fn:contains(item.themaEnvrnCl,'걷기길') ? 'checked' : '' }>
					...
					<ul>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'텐트') ? 'checked' : '' }
							id="eqpmnLendCl01" value="텐트"> <label for="eqpmnLendCl01">텐트</label>
						</li>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'릴선') ? 'checked' : '' }
							id="eqpmnLendCl02" value="릴선"> <label for="eqpmnLendCl02">릴선</label>
						</li>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'화로대') ? 'checked' : '' }
							id="eqpmnLendCl03" value="화로대"> <label for="eqpmnLendCl03">화로대</label>
						</li>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'난방기구') ? 'checked' : '' }
							id="eqpmnLendCl04" value="난방기구"> <label for="eqpmnLendCl04">난방기구</label>
						</li>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'식기') ? 'checked' : '' }
							id="eqpmnLendCl05" value="식기"> <label for="eqpmnLendCl05">식기</label>
						</li>
						<li><input type="checkbox" name="eqpmnLendCl" class="check04" ${fn:contains(item.eqpmnLendCl,'침낭') ? 'checked' : '' }
					...
					<ul>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'산책로') ? 'checked' : '' }
							id="posblFcltyCl01" value="산책로"> <label for="posblFcltyCl01">산책로</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'낚시') ? 'checked' : '' }
							id="posblFcltyCl02" value="낚시"> <label for="posblFcltyCl02">낚시</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl, '계곡 물놀이') ? 'checked' : '' }
							id="posblFcltyCl03" value="계곡 물놀이"> <label for="posblFcltyCl03">계곡 물놀이</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'강/물놀이') ? 'checked' : '' }
							id="posblFcltyCl04" value="강/물놀이"> <label for="posblFcltyCl04">강/물놀이</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'어린이놀이시설') ? 'checked' : '' }
							id="posblFcltyCl05" value="어린이놀이시설"> <label for="posblFcltyCl05">어린이놀이시설</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'운동장') ? 'checked' : '' }
							id="posblFcltyCl06" value="운동장"> <label for="posblFcltyCl06">운동장</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'청소년체험시설') ? 'checked' : '' }
							id="posblFcltyCl07" value="청소년체험시설"> <label for="posblFcltyCl07">청소년체험시설</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'농어촌체험시설') ? 'checked' : '' }
							id="posblFcltyCl08" value="농어촌체험시설"> <label for="posblFcltyCl08">농어촌체험시설</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'해수욕') ? 'checked' : '' }
							id="posblFcltyCl09" value="해수욕"> <label for="posblFcltyCl09">해수욕</label>
						</li>
						<li><input type="checkbox" name="posblFcltyCl" class="check04" ${fn:contains(item.posblFcltyCl,'수상레저') ? 'checked' : '' }
					...
					<ul>
						<c:forEach items="${tags }" var="tag" varStatus="st">
							<li><input type="checkbox" name="tag" class="check04"
								id="tag${st.index }" value="${tag.tagNum }" ${fn:contains(item.tags, tag.tagNum) ? 'checked' : '' }> <label for="tag${st.index }">#${tag.tagName }</label>
							</li>
						</c:forEach>
					</ul>
